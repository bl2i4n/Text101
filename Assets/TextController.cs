...
public class TextController : MonoBehaviour {
	...
	void Update () {
			...
			//need these three functions					
									
			//use state diagram to program the code flow
	...
	void corridor_3 () {
		text.text = "You're standing back in the corridor, now convincingly dressed as a cleaner. " +
					"You strongly consider the run for freedoms\n\n " +
	...
	void stairs_0 () {
		text.text = "You start walking up the stairs towards the outside light. " +
					"You realise it's not break time, and you'll be cauhgt immediately. " +
	...
	void stairs_1 () {
		text.text = "Unfortunately wielding a puny hairclip hasn't given you the " +
					...
					"Press R to Retreat down the stars" ;
